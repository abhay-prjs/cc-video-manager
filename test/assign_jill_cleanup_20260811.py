"""Cleanup pass for assign_jill_20260811.py: mark the 5 ops-assign Discord messages
...
ASSIGNMENTS = [
    ("1536484421895462975", "Phrasly 1", "Natashka", "Jill"),
    ("1536484381701447803", "manus 1 8/10/26 (3vids)", "Henry", "Jill"),
    ("1536487425147277333", "Higgsfield 1", "Natashka", "Jill"),
    ("1536490869803319390", "phrasly batch 21", "Joshua", "Jill"),
    ("1536520631536062549", "Composio raw", "Reuben", "Jill"),
]
